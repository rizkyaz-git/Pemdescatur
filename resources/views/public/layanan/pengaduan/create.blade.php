...
@section('title', 'Tulis Laporan & Pengaduan Online - Pemerintah Desa Catur')
            ...
            ['label' => 'Tulis Laporan']
                ...
                <div class="flex items-center gap-3.5">
                    <a href="{{ route('warga.complaint.index') }}"
                        ...
                        title="Kembali ke Daftar Laporan" aria-label="Kembali">
                    ...
                    <div>
                        <h1 class="font-serif text-2xl font-bold text-slate-900 tracking-tight">Tulis Laporan &amp; Aspirasi
                            Warga</h1>
                        <p class="text-xs text-slate-500 mt-0.5">Sampaikan laporan permasalahan atau masukan fasilitas untuk
                            Desa Catur.</p>
                    </div>
                </div>
            </div>
