            ...
            <div class="bg-white rounded-xl shadow-xl border border-slate-100 p-6 sm:p-8">
                        ...
                        <div class="flex items-center justify-between mb-1">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}"
                                    class="text-xs text-slate-500 hover:text-[#0A3D29] transition">
                                    Lupa kata sandi?
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="flex items-center">
                        <label for="remember_me" class="inline-flex items-center gap-2 cursor-pointer select-none">
                            <input id="remember_me" type="checkbox" name="remember"
                                class="w-4 h-4 rounded border-slate-300 text-[#0A3D29] focus:ring-[#0A3D29]">
                ...
                <div class="mt-6 pt-4 border-t border-slate-100 text-center">
                    <p class="text-xs text-slate-500">
                        ...
                        @else
                            <span class="text-slate-400 ml-1">Hubungi Administrator</span>
                        @endif
                    </p>
                </div>
