...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="font-serif text-2xl font-bold text-gray-800">➕ Tambah Data Penduduk</h1>
            <p class="text-xs text-gray-500 mt-1">Lengkapi biodata penduduk dan hubungkan dengan Kartu Keluarga (KK).</p>
        </div>
        ...
        <form action="{{ route('admin.residents.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="nik" id="nik" value="{{ old('nik') }}" maxlength="16" required
                        placeholder="Contoh: 3309121205900001"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="relationship_to_head" id="relationship_to_head" value="{{ old('relationship_to_head') }}"
                        placeholder="Kepala Keluarga, Istri, Anak, dll"
