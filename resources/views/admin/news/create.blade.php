...
@push('styles')
    ...
    <style>
        ...
        /* Responsive quill toolbar overflow */
        .ql-toolbar {
            overflow-x: auto;
            white-space: nowrap;
        }
        ...
        /* Quill content typography styling */
        .ql-editor h1,
        .ql-editor h2,
        .ql-editor h3 {
...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        <div class="flex items-center gap-3">
            ...
            <h1 class="font-jakarta text-xl sm:text-2xl font-bold text-[#0F172A]">Tambah Berita Baru</h1>
        </div>

        <div class="bg-white rounded-xl border border-[#E2E8F0] shadow-xs p-5 sm:p-7" x-data="{
                    categoryDropdownOpen: false,
                    selectedCategory: '{{ old('category', 'Berita') }}',
            ...
            <form id="news-form" action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-5">
                @csrf
                <input type="hidden" name="status" id="news-status-input" value="published">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div>
                        ...
                        <div class="relative flex items-center">
                            ...
                            <input type="text" name="author" id="author" value="{{ old('author', 'Admin Pemdes Catur') }}"
                ...
                <div>
                    <label class="block text-[13px] font-semibold text-[#1E293B] mb-2">Upload Gambar Sampul
                        (Opsional)</label>
