...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        <div class="flex items-center gap-3.5">
            ...
            <h1 class="font-jakarta text-2xl font-bold text-[#0F172A]">Edit Berita</h1>
        </div>
                        ...
                        @if($news->image_path)
                            <div class="flex items-center gap-4 p-3 bg-white border border-[#E2E8F0] rounded-xl mb-3">
                                <img src="{{ asset('storage/' . $news->image_path) }}"
                                    class="w-20 h-20 object-cover rounded-lg border border-[#E2E8F0]">
                                <p class="text-xs text-slate-500">Pilih berkas foto baru di bawah jika ingin mengganti gambar
                                    sampul ini.</p>
                            </div>
                        @endif
