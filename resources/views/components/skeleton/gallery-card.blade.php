...
<div {{ $attributes->merge(['class' => 'break-inside-avoid mb-4 sm:mb-5 lg:mb-6 rounded-lg overflow-hidden bg-slate-200 relative skeleton-shimmer ' . $aspect]) }} aria-hidden="true">
